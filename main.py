...
class FaceRecognitionApp:
    def __init__(self, root):
        ...
        self.sample_count = 0
        self.model_type = tk.StringVar(value="ANN")  # Default model type
        self.model_ann = None
        self.model_cnn = None
    ...
    def collect_face(self, gray, x, y, w, h):
        ...
        self.sample_count += 1
        progress = min(int(self.sample_count / 100 * 100), 100)  # Max 100 samples
            ...
            for person_dir in person_dirs:
                ...
                for img_file in os.listdir(person_path):
                    if img_file.endswith('.jpg'):
                        ...
                        if img is not None:
                            X.append(img)
                            y.append(person_dir)  # Use full directory name as label
    ...
    def recognize_face(self, gray, x, y, w, h):
        try:
            ...
            if confidence > 70:  # Confidence threshold
                ...
                # Extract name from directory format (id_name)
    ...
    def on_closing(self):
        self.camera_active = False
        time.sleep(0.5)  # Give time for threads to close
        self.root.destroy()
        sys.exit(0)
